...
class Utility(commands.Cog):
    ...
    async def help_cmd(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="Utility", value="`/ping`, `/about`, `/help`, `/desc`, `/avatar`, `/conv`, `/page`, `/playing`, `/members`, `/trim`, `/whois`, `/tex`, `/translate`, `/translate_langs`, `/quote`, `/listen`, `/unlisten`, `/mirror`, `/unmirror`, `/toggle_greetings`", inline=False)
